    ...
    return ResearchOutput(
        ...
        results=[
            ResearchResult(
                ...
                content="AI is revolutionizing software development by automating tasks like code generation, testing, and debugging. AI-powered tools can significantly increase developer productivity."
            ),
            ResearchResult(
                url="http://example.com/dev-tools",
                content="Modern development environments are increasingly integrating AI assistants. These assistants, or agents, can provide real-time feedback, suggest code improvements, and even write entire functions."
            ),
        ]
    )
