...
def test_create_key_finding():
    finding = KeyFinding(finding_id=1, title="Test Finding", summary="This is a test finding.", citations=["http://example.com"])
...
def test_create_intelligence_report():
    ...
    report = IntelligenceReport(topic="Test Topic", executive_summary="This is a test summary.", key_findings=[finding])
