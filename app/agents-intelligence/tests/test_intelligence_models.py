...
def test_intelligence_report_with_research_output():
    ...
    research_output = ResearchOutput(topic="Test Topic", summary="This is a test summary.", results=[ResearchResult(url="http://example.com", content="This is test content.")], history=[])
    report = IntelligenceReport(
